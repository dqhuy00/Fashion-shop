    ...
    <div class="authentication-inner">
        ...
        <div class="card">
            <div class="card-body">
                ...
                <!-- /Logo -->
                <h4 class="mb-2">Chào Mừng 👋</h4>
                <p class="mb-4">Vui lòng đăng nhập vào tài khoản của bạn và bắt đầu cuộc phiêu lưu</p>
                <?php if (!empty($message['error']) && $message['error']) : ?>
                    <p class=" mb-2 text-center text-danger">
                        <?= $message['error'] ?>
                    </p>
                <?php endif ?>
                <form id="formAuthentication" class="mb-3" action="?controller=auth&action=login" method="POST">
                    <div class="mb-3">
                        <label for="username" class="form-label">tài khoản</label>
                        <input type="text" class="form-control" id="username" name="username" value="<?= old('username') ?>" placeholder="nhập tài khoản của bạn" autofocus />
